...
func (b *Broker) RegisterPlaceholder(sandboxID domain.SandboxID, host, realToken string) (PlaceholderRecord, error) {
	return b.register(sandboxID, host, realToken, mintPlaceholder)
}

func (b *Broker) register(sandboxID domain.SandboxID, host, realToken string, mint func() (string, error)) (PlaceholderRecord, error) {
	if host == "" {
...
func (b *Broker) RegisterJWTPlaceholder(sandboxID domain.SandboxID, host, realToken string) (PlaceholderRecord, error) {
	return b.register(sandboxID, host, realToken, mintJWTPlaceholder)
}
