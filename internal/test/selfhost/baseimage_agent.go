...
`,
		...
		srcCopyBlock,      // source-tree COPY lines (only dirs present in context) — %s at line 366
		ClaudeCodeVersion, // npm install -g @anthropic-ai/claude-code@%s — %s at line 379
	)
}
