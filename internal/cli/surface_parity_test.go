...
import (
	...
	mcp "github.com/IniZio/nexus/internal/mcp"
)
...
var surfaceMap = []surfaceEntry{
	...
	{CLIVerb: "sandbox", CanonicalMethods: []string{"service.Create", "service.List", "service.Start", "service.Stop", "service.Remove"}, MCPTools: []string{"sandbox_create", "sandbox_list", "sandbox_start", "sandbox_stop", "sandbox_pause", "sandbox_resume", "sandbox_remove"}},
