...
1. Pick an example matching your stack
2. Follow the README step-by-step
3. Run the demo.sh script to see it in action
4. Adapt the Dockerfile and compose file for your project
