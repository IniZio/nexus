...
test-skill-nexus.py
====================
Fixture-driven tests for plugins/claude/skills/nexus/scripts/emit_flags.py.
...
# __file__ = <repo>/scripts/docs/test-skill-nexus.py → three dirname calls reach repo root.
_repo_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
sys.path.insert(0, os.path.join(_repo_root, "plugins", "claude", "skills", "nexus", "scripts"))
