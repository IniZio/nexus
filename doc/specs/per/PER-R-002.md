...
- **Why** — The core value of the detached supervisor is decoupling perimeter lifetime from the one-shot CLI. If egress dies on CLI exit, orca-launched sandboxes have no network after `nexus orca create` returns.
