...
Charter trace prefix: `REQ-HPO-*` maps to spec nodes `HPO-R-001` … `HPO-R-010`.

Motive: `herdr-plugin-ootb`. Slices T1–T8 implement these requirements; T9 authored this spec.
