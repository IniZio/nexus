...
- **Verification** automated · **Criticality** must · **Source** nexus3-mount-creds-ssh-relay#AC-2
- **Tests** `TestClaudeReadyMatch_AutoModeFooter` (`internal/cli/claude_ready_match_test.go:21`); `TestClaudeReadyMatch_MatchesAutoTranscript` (`claude_ready_match_test.go:39`); `TestClaudeReadyMatch_DoesNotMatchBypassFooter` (`claude_ready_match_test.go:51`)
