...
- **Tests** `TestRelayRefusalIsPktLineERR` (`internal/core/gitssh/relay_test.go:191`); `TestRelayRefusesPolicy` (`relay_test.go:241`); `TestRelayReceivePack_RefBlocked` (`relay_test.go:273`); `TestDeriveAllowlist_ExampleLMS` (`internal/core/gitssh/policy_test.go:25`); `TestDeriveAllowlist_Deduplication` (`policy_test.go:67`); `TestParseCommand` (`internal/core/gitssh/command_test.go:10`)
