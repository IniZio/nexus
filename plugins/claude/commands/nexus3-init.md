...
Run `/nexus3:nexus3-init` once per repo, before the first `nexus3 herdr workspace-create` or `nexus3 create`. If `nexus3.yaml` already exists, read it directly instead.
