...
emit_flags.py
=============
Reference implementation of the nexus skill manifest-probe logic.

Given a project root directory and a slug, prints the --mount-named flag
fragments that the nexus skill would emit, one flag per line, ready to
be pasted into a `nexus sandbox create` invocation.
